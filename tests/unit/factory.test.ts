...
import { FabricSqlClient } from "../../src/clients/fabric-sql-client.js";
...
describe("createMicrosoftApiClients", () => {
  it("constructs REST and SQL clients around one configured authentication boundary", () => {
    const logger: Logger = {
      debug: vi.fn(),
      info: vi.fn(),
      warn: vi.fn(),
    ...
    expect(clients.fabricSql).toBeInstanceOf(FabricSqlClient);
